...
% 	\rfoot{Halaman \thepage}%
    ...
    % Judul Tugas Akhir
    \title{PENGEMBANGAN DETEKSI POSISI JATUH PADA LANSIA MENGGUNAKAN \textit{GRAPH CONVOLUTIONAL NETWORK} BERBASIS \textit{POSE LANDMARK}} 	
    % DITULIS DALAM HURUF KAPITAL; Font size 16 pt; Bold; Tidak melebihi 4 baris
    \titleEN{DEVELOPMENT OF FALL POSITION DETECTION IN THE ELDERLY USING A POSE LANDMARK-BASED CONVOLUTIONAL GRAPH NETWORK}      % Judul Tugas Akhir dalam Bahasa Inggris
    
    % Informasi Mahasiswa
    \author{Leonardo Alfontus Mende Sirait}		% Nama Mahasiswa
	\nim{121140028}			% NIM Mahasiswa
	
	%Informasi Dosen Pembimbing
	\dosbingA%
		{Martin C.T. Manullang, Ph.D.}%	% Nama Dosen Pembimbing 1
		{NIP. 199301092019031017}				% NIP Dosen Pembimbing 1
	\dosbingB%
		{Leslie Anggraini, S.Kom., M.Cs.}%	% Nama Dosen Pembimbing 2
		{NIP. 199708172025212082}				% NIP Dosen Pembimbing 2
		
	%Informasi Dosen Penguji
	\pengujiA%
		{Rahman Indra Kesuma, S.Kom., M.Cs.}%	% Nama Dosen Penguji 1
		{NIP. 199105302019031018}				% NIP Dosen Penguji 1
	\pengujiB%
		{Hartanto Tantriawan, S.Kom., M.Kom.}%	% Nama Dosen Penguji 2
		{NIP. 199205222019031012}				% NIP Dosen Penguji 2
